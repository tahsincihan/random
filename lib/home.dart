    ...
    try {
      ...
      if (token != null) {
        final response = await http.get(
          Uri.parse('https://mapyourevent.myeenterprises.co.uk/api/admin/user'),
          headers: {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          kTestMode == 1 ? '(TEST) Welcome $storedUserName' : 'Welcome, $storedUserName',
                    ...
                    MobileScanner(
                      ...
                      onDetect: (capture) async {
                        ...
                        if (barcodes.isNotEmpty) {
                          ...
                          cameraController.stop();
                          final player = PlaySound(soundPath:'sounds/scan-success.mp3');
                          player.play();
