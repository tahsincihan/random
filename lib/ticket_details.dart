...
class _TicketDetailsScreenState extends State<TicketDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool canAdmit = status.toLowerCase() == 'active' || status.toLowerCase() == 'reserved' || status.toLowerCase() == 'refunded';
                                ...
                                if (response.statusCode == 200) {
                                  ...
                                  if (data["success"] == true) {
                                    ...
                                    if (punchResult["success"] == true) {
                                      ...
                                      final player = PlaySound(soundPath: 'sounds/ticket-error.mp3');
                                      player.play();
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
